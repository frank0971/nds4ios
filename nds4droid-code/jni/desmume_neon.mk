...
LOCAL_SRC_FILES			:= 	desmume/src/addons/slot1_none.cpp \
							...
							desmume/src/android/dynarec/arm_stub.S\
...
LOCAL_ARM_NEON 			:= true
LOCAL_ARM_MODE 			:= arm
LOCAL_CFLAGS			:= -DANDROID -DHAVE_LIBZ -DNO_MEMDEBUG -DNO_GPUDEBUG -DHAVE_JIT -DHAVE_CJIT -DUSE_EXOPHASEJIT -DHAVE_NEON=1 -mfloat-abi=softfp -mfpu=neon -marm -march=armv7-a -mtune=cortex-a9
LOCAL_STATIC_LIBRARIES 	:= mathneon sevenzip tinyccarm
