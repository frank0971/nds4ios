...
LOCAL_SRC_FILES			+=	desmume/src/android/dynarec/arm_stub.S\
							desmume/src/android/dynarec/cpu_threaded.cpp\
							desmume/src/android/dynarec/cpu.cpp\
							desmume/src/android/dynarec/dynarec_linker.cpp\
							desmume/src/android/dynarec/warm.cpp\
							desmume/src/android/dynarec/exophasejit.cpp
endif
LOCAL_SRC_FILES			+=	desmume/src/filter/2xsai.cpp \
...
LOCAL_CFLAGS			:= -DANDROID -DHAVE_LIBZ -DNO_MEMDEBUG -DNO_GPUDEBUG -DHAVE_JIT -DHAVE_CJIT
LOCAL_STATIC_LIBRARIES 	:= sevenzip
LOCAL_LDLIBS 			:= -llog -lz -lGLESv2 -lEGL -ljnigraphics -lOpenSLES -landroid

ifeq ($(TARGET_ARCH_ABI),x86)
LOCAL_STATIC_LIBRARIES  += tinyccx86
LOCAL_SRC_FILES			+= desmume/src/arm_jit.cpp \
						   desmume/src/utils/AsmJit/x86/x86assembler.cpp \
						   desmume/src/utils/AsmJit/x86/x86compiler.cpp \
						   desmume/src/utils/AsmJit/x86/x86compilercontext.cpp \
						   desmume/src/utils/AsmJit/x86/x86compilerfunc.cpp \
						   desmume/src/utils/AsmJit/x86/x86compileritem.cpp \
						   desmume/src/utils/AsmJit/x86/x86cpuinfo.cpp \
						   desmume/src/utils/AsmJit/x86/x86defs.cpp \
						   desmume/src/utils/AsmJit/x86/x86func.cpp \
						   desmume/src/utils/AsmJit/x86/x86operand.cpp \
						   desmume/src/utils/AsmJit/core/assembler.cpp \
						   desmume/src/utils/AsmJit/core/assert.cpp \
						   desmume/src/utils/AsmJit/core/buffer.cpp \
						   desmume/src/utils/AsmJit/core/compiler.cpp \
						   desmume/src/utils/AsmJit/core/compilercontext.cpp \
						   desmume/src/utils/AsmJit/core/compilerfunc.cpp \
						   desmume/src/utils/AsmJit/core/compileritem.cpp \
						   desmume/src/utils/AsmJit/core/context.cpp \
						   desmume/src/utils/AsmJit/core/cpuinfo.cpp \
						   desmume/src/utils/AsmJit/core/defs.cpp \
						   desmume/src/utils/AsmJit/core/func.cpp \
						   desmume/src/utils/AsmJit/core/logger.cpp \
						   desmume/src/utils/AsmJit/core/memorymanager.cpp \
						   desmume/src/utils/AsmJit/core/memorymarker.cpp \
						   desmume/src/utils/AsmJit/core/operand.cpp \
						   desmume/src/utils/AsmJit/core/stringbuilder.cpp \
						   desmume/src/utils/AsmJit/core/stringutil.cpp \
						   desmume/src/utils/AsmJit/core/virtualmemory.cpp \
						   desmume/src/utils/AsmJit/core/zonememory.cpp
endif

ifeq ($(TARGET_ARCH_ABI),armeabi)
LOCAL_STATIC_LIBRARIES  += tinyccarm
LOCAL_CFLAGS			+= -DUSE_EXOPHASEJIT
endif
